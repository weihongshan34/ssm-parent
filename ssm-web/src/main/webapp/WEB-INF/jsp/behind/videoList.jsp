    ...
    <div class="navbar-right" style="padding-right: 17px">
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                <li><a href="${pageContext.request.contextPath}/video/list?page=1&size=10">首页</a></li>
                <li><a href="${pageContext.request.contextPath}/video/list?page=${queryVo.page}&size=10&title=${queryVo.title}&speakerId=${queryVo.speakerId}&courseId=${queryVo.courseId}">${queryVo.page}</a></li>

                <c:if test="${queryVo.page+1 <= page.pages}">
                    <li><a href="${pageContext.request.contextPath}/video/list?page=${queryVo.page+1}&size=10&title=${queryVo.title}&speakerId=${queryVo.speakerId}&courseId=${queryVo.courseId}">${queryVo.page+1}</a></li>
                </c:if>

                <c:if test="${queryVo.page+2 <= page.pages}">
                    <li><a href="${pageContext.request.contextPath}/video/list?page=${queryVo.page+2}&size=10&title=${queryVo.title}&speakerId=${queryVo.speakerId}&courseId=${queryVo.courseId}">${queryVo.page+2}</a></li>
                </c:if>
                <li><a href="${pageContext.request.contextPath}/video/list?page=${page.pages}&size=10&title=${queryVo.title}&speakerId=${queryVo.speakerId}&courseId=${queryVo.courseId}">尾页</a></li>
                <li>
