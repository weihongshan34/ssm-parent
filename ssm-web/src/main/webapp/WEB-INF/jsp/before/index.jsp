...
<header>
    <div class="container">
        ...
        <div id="userBlock" style="display:none;float:right">
            ...
            <a href="/user/showMyProfile" id="account">${sessionScope.username}</a>
        </div>

        <a onclick="JavaScript:addFavorite2()"><img src="${pageContext.request.contextPath}/img/sc.png"
                                                    draggable="false">加入收藏</a>
        <a onclick="pyRegisterCvt()" target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=1743465919&site=qq&menu=yes"><img
...
<nav class="w100">
    <div class="container">
        ...
        <ul class="text_13 f_right">
            <li>
                <a href="/user/view" target="_blank">首页</a>
            </li>
            <li class="nav_down">
    ...
    <div class="container">
        ...
        <div class="course-info">
            ...
            <a onclick="pyRegisterCvt()" target="_blank"
               href="http://wpa.qq.com/msgrd?v=3&uin=1743465919&site=qq&menu=yes">
